...
summary: "We tested the RNR-A's predictive utility for IPV recidivism in a cohort of 3,145 clients. IPV reconvictions (10% over 24 months) increased with risk level. Discrimination was comparable to similar instruments (AUC .59–.68). The tool showed high sensitivity but low specificity, supporting its use as a screening tool."
editPost:
...
```BibTeX
@article{SPD23,
author = {Louise C. Starfelt Sutton and Björn N. Persson and Maria Danielsson},
year = {2023},
title = {Predicting Intimate Partner Violence Recidivism Using the Swedish Prison and Probation Service's Risk-Need-Responsivity Assessment (RNR-A)},
